...
✥ Managed by : [OWNER](https://t.me/{OWNER})
✥ Thanks To  : [MON](https://t.me/mondisini) | [VICKY](https://t.me/VckyouuBitch)
...
def map(pos):
    if(pos==1):
        ...
        button = [
            ...
            [InlineKeyboardButton(text = '☀️ ᴄʜᴀɴɴᴇʟ', url=f"https://t.me/{UPDATES_CHANNEL}"),
